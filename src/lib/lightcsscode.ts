...
@layer components {
    ...
    .btn.variant-destructive{
        @apply border-secondary-700 from-secondary-500 to-secondary-600 shadow-secondary-950/25 before:border-white/25 hover:brightness-110 active:brightness-95 
    }
    ...
    .badge.variant-danger{
        @apply bg-secondary-500/15 border-secondary-500/15 text-secondary-700
    }
    ...
    .callout.variant-danger{
        @apply bg-secondary-50 [--title-text-color:theme(colors.danger.950)] 
    }
