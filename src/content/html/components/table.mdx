...
import CodeHightLight from '@components/CodeHightLight';
import TableDefault from "@components/tables/table.astro"
...
<div className="space-y-20" data-theme="dark">
 
  <PreviewBlock codeBlocks={[{ code: `<TableDefault />`, lang: "html" }]}>
    <TableDefault />
</PreviewBlock>
 ...
 <CodeHightLight 
    ...
    >
      {/* Aquí va el componente que deseas renderizar */}
      <TableDefault />
    </CodeHightLight>
